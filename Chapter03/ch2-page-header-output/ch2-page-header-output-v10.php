<?php
/*
  Plugin Name: Chapter 2 - Page Header Output V9
  Plugin URI: 
  Description: Companion to recipe 'Create network-level admin pages'
  Author: ylefebvre
  Version: 1.0
...
function ch2pho_settings_menu() {
	if ( is_multisite() ) {
        $options_page = add_submenu_page( 'settings.php',
            ...
            'manage_options', 'ch2pho-my-google-analytics', 'ch2pho_config_page' );
    } else {
